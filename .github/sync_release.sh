...
UPSTREAM_REPO="https://github.com/MiSTer-devel/SuperCassetteVision_MiSTer.git"
CORE_NAME=(SCV)
...
UPSTREAM_CORE_NAME=(SCV)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(scv.qpf)
COMPILATION_OUTPUT=(output_files/scv.rbf)
